...
const categories = [
  ...
  { key: "wands", name: "Wands", match: (name: string) => /权杖/.test(name) },
  { key: "cups", name: "Cups", match: (name: string) => /圣杯/.test(name) },
  { key: "swords", name: "Swords", match: (name: string) => /宝剑/.test(name) },
  {
    key: "pentacles",
    name: "Pentacles",
